...
public class Main {
    ...
    private static final String GRADE_FILE_PATH = "C:\\Users\\Lisna Ima\\Documents\\MSIB-Binar\\chapter3\\ch3-java-unit-test\\res\\data_sekolah.csv";
    private static final String SCHOOL_FILE_PATH = "C:\\Users\\Lisna Ima\\Documents\\MSIB-Binar\\chapter3\\ch3-java-unit-test\\res\\data_sekolah.txt";
    private static final String CLASS_FILE_PATH = "C:\\Users\\Lisna Ima\\Documents\\MSIB-Binar\\chapter3\\ch3-java-unit-test\\res\\data_per_kelas.txt";
    ...
    public static void writeFile(String txtFile, String txt) throws IOException {
        ...
        try {
            ...
            System.out.println("Gagal membuat file txt");
            e.printStackTrace();
        } finally {
